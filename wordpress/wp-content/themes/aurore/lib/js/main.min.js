  ...
  $.fn.featureCarousel = function (options) {
    ...
    var animateFeature = function($feature, direction)
    {
      ...
      if (newPosition == 1) {
        ...
        var $textCaption = $('.activeCarousel').find(".carousel-caption > p").text();

		$('.textCaption').remove();
		var $captionPos = $('<div></div>');
		$captionPos.addClass('textCaption');
		$('#carousel').append($captionPos.text($textCaption));
...
$(document).ready(function() {
	...
	print_article();
	carousel();
	var url = 'http://localhost/wordpress/'; //URL à atteindre
	var temp = 100; //Delai avant la redirection en millisecondes
...
{
	setTimeout("window.location=http://localhost/wordpress/index.php/index/",temp);
