...
/*      if (options.trackerIndividual) {
      ...
      if (options.trackerSummation) {
        ...
        var $trackerContent = $('<div></div>').append($current).append($middle).append($total);
       	/*var tracker = $('.tracker-summation-container');*/
       	var $btnLeft = $('<a href="#" id="but_prev"></a>').html('<img src="'+ template_directory +'/img/arrow-left.png">');
        var $btnRight = $('<a href="#" id="but_next"></a>').html('<img src="'+ template_directory +'/img/arrow-right.png">');
        // Add it all together
        /*$('.tracker-summation-container').append(btnLeft);*/
        /*tracker.prepend(btnRight);*/
        // Add it all together
        $tracker.append($btnLeft).append($btnRight).append($trackerContent);
        // Insert into DOM
    ...
    var animateFeature = function($feature, direction)
    {
      ...
      if (newPosition == 1) {
        ...
        new_left = '343px';
        new_fade = 1.0;
        $('.activeCarousel').removeClass('activeCarousel');
        $feature.addClass('activeCarousel');
...
$(document).ready(function() {
	...
	if($('.chevron img').css('display', 'block')) {
		$('.chevron img').one('click', clickChevronDown);
	}
	if($('.curved img').css('display', 'block')) {
		$('.curved img').one('click', clickChevronFooterDown);
	}
});
...
$(document).ready(function() {
	...
	if($('.chevron img').css('display', 'none')) {
		$('.chevron img').one('click', clickChevronDown);
	}
	if($('.curved img').css('display', 'block')) {
		$('.curved img').one('click', clickChevronFooterDown);
...
function clickChevronDown() {
	$('.top-bar').slideDown(800, function() {
		$('.chevron img').attr('src', template_directory+'/img/chevronUp.png');
	});
	$('.chevron img').one('click', clickChevronUp);
}

function clickChevronUp() {
	$('.top-bar').slideUp(800, function() {
		$('.chevron img').attr('src', template_directory+'/img/chevronDown.png');
	});
	$('.chevron img').one('click', clickChevronDown);
}

function clickChevronFooterUp() {
	$('.bottom-bar').slideUp(800, function() {
		$('.curved img').attr('src', template_directory+'/img/chevronUp.png');
	});
	$('.curved img').one('click', clickChevronFooterDown);
}

function clickChevronFooterDown() {
	$('.bottom-bar').slideDown(800, function() {
		$('.curved img').attr('src', template_directory+'/img/chevronDown.png');
	});
	$('.curved img').one('click', clickChevronFooterUp);
}

/*Code page Bepos les cles*/
function get_tab() {
	$('.firstTabs li a').click(function(e) {
		e.preventDefault();
		$('.firstTabs li.active').removeClass('active');
		$(this).parent().addClass('active');
		var onglet = $(this).attr('class');
		get_articles(onglet);
	});
}

function print_article() {
	var content = $('.sousMenus ul li:first-child').find('.content-article').html();
	$('.tab_content .content').html(content);

	var image = $('.sousMenus ul li:first-child').find('.imgArticle').clone();
	$('.tab_content .image').html(image);

	$('.sousMenus ul li').click(function() {
		$('.sousMenus ul li.active').removeClass('active');
		$(this).addClass('active');
		var content = $(this).find('.content-article').html();
		$('.tab_content .content').html(content);

		var image = $(this).find('.imgArticle').clone();
		$('.tab_content .image').html(image);
	});
}

function get_articles(cat) {

	$('.sousMenus').html($('.spinner').clone());
	$('.tab_content .content').html($('.spinner').eq(0).clone());
	$('.tab_content .image').html('');
